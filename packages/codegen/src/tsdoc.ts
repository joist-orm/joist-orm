...
export const tsdocComments = {
    entity: {
        ...
        load: makeTsDocComment("Traverse from this entity using a lens, and load the result.",
            "",
        ...
        toJSON: makeTsDocComment("Build a type-safe, loadable and relation aware POJO from this entity, given a hint.",
            "",
