...
/** Batches m2m.load calls via BatchLoader. */
export function manyToManyBatchLoader<T extends Entity, U extends Entity>(
  em: EntityManager,
...
async function loadBatch<T extends Entity, U extends Entity>(
  collection: ManyToManyCollection<T, U>,
  keys: string[],
): Promise<void> {
