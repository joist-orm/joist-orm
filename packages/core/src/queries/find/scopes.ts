import { maybeGetMetadataForType } from "src/configure.ts";
import type { Entity } from "src/Entity.ts";
import type { EntityManager, FindFilterOptions, MaybeAbstractEntityConstructor } from "src/EntityManager.ts";
