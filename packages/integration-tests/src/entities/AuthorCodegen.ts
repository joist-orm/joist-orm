// Generated by joist-codegen (hash=8c09ee)
import {
  BaseEntity,
  BooleanFilter,
...
export interface AuthorFilter {
  ...
  favoriteBook?: EntityFilter<Book, BookId, FilterOf<Book>, null | undefined>;
...
export interface AuthorGraphQLFilter {
  ...
  favoriteBook?: EntityGraphQLFilter<Book, BookId, GraphQLFilterOf<Book>, null | undefined>;
...
export abstract class AuthorCodegen extends BaseEntity<EntityManager> {
  ...
  abstract readonly favoriteBook: PersistedAsyncProperty<Author, Book | undefined>;
