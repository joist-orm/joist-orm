// Generated by joist-codegen (hash=c642ed.7313)
import {
  BaseEntity,
  Changes,
  ConfigApi,
...
export interface AuthorStatFilter {
  ...
  integerNull?: ValueFilter<number, null | undefined>;
...
export interface AuthorStatGraphQLFilter {
  ...
  integerNull?: ValueGraphQLFilter<number>;
...
export abstract class AuthorStatCodegen extends BaseEntity<EntityManager> {
  ...
  get integerNull(): number | undefined {
    return this.__orm.data["integerNull"];
  }

  set integerNull(integerNull: number | undefined) {
    setField(this, "integerNull", integerNull);
  }
