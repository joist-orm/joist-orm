...
export type ImageTypeDetails = { id: number; code: ImageType; name: string; sortOrder: 100 | 200 | 300; visible: boolean; nickname: "book_image" | "author_image" | "publisher_image" };
...
const details: Record<ImageType, ImageTypeDetails> = {
  ...
  [ImageType.PublisherImage]: { id: 3, code: ImageType.PublisherImage, name: "Publisher Image", sortOrder: 300, visible: true, nickname: "publisher_image" },
};
