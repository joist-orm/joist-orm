...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    favoriteColors: { kind: "enum", fieldName: "favoriteColors", fieldIdName: undefined, required: false, enumType: Color, serde: new EnumArrayFieldSerde("favoriteColors", "favorite_colors", Color), immutable: false },
...
export const bookAdvanceMeta: EntityMetadata<BookAdvance> = {
  ...
  fields: {
    ...
    createdAt: { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("createdAt", "created_at", "timestamp with time zone"), immutable: false },
    updatedAt: { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("updatedAt", "updated_at", "timestamp with time zone"), immutable: false },
    status: { kind: "enum", fieldName: "status", fieldIdName: undefined, required: true, enumType: AdvanceStatus, serde: new EnumFieldSerde("status", "status_id", AdvanceStatus), immutable: false },
...
export const imageMeta: EntityMetadata<Image> = {
  ...
  fields: {
    ...
    createdAt: { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("createdAt", "created_at", "timestamp with time zone"), immutable: false },
    updatedAt: { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("updatedAt", "updated_at", "timestamp with time zone"), immutable: false },
    type: { kind: "enum", fieldName: "type", fieldIdName: undefined, required: true, enumType: ImageType, serde: new EnumFieldSerde("type", "type_id", ImageType), immutable: false },
...
export const publisherMeta: EntityMetadata<Publisher> = {
  ...
  fields: {
    ...
    createdAt: { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("createdAt", "created_at", "timestamp with time zone"), immutable: false },
    updatedAt: { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("updatedAt", "updated_at", "timestamp with time zone"), immutable: false },
    size: { kind: "enum", fieldName: "size", fieldIdName: undefined, required: false, enumType: PublisherSize, serde: new EnumFieldSerde("size", "size_id", PublisherSize), immutable: false },
    type: { kind: "enum", fieldName: "type", fieldIdName: undefined, required: true, enumType: PublisherType, serde: new EnumFieldSerde("type", "type_id", PublisherType), immutable: false },
