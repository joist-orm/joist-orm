...
export const authorMeta: EntityMetadata<Author> = {
  ...
  tableName: "authors",
  fields: {
    id: { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new PrimaryKeySerde(() => authorMeta, "id", "id") },
    ...
    mentor: { kind: "m2o", fieldName: "mentor", fieldIdName: "mentorId", required: false, otherMetadata: () => authorMeta, otherFieldName: "authors", serde: new ForeignKeySerde("mentor", "mentor_id", () => authorMeta) },
    publisher: { kind: "m2o", fieldName: "publisher", fieldIdName: "publisherId", required: false, otherMetadata: () => publisherMeta, otherFieldName: "authors", serde: new ForeignKeySerde("publisher", "publisher_id", () => publisherMeta) },
...
export const bookMeta: EntityMetadata<Book> = {
  ...
  tableName: "books",
  fields: {
    id: { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new PrimaryKeySerde(() => bookMeta, "id", "id") },
    ...
    createdAt: { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("createdAt", "created_at", "timestamp with time zone") },
    updatedAt: { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("updatedAt", "updated_at", "timestamp with time zone") },
    author: { kind: "m2o", fieldName: "author", fieldIdName: "authorId", required: true, otherMetadata: () => authorMeta, otherFieldName: "books", serde: new ForeignKeySerde("author", "author_id", () => authorMeta) },
...
export const bookAdvanceMeta: EntityMetadata<BookAdvance> = {
  ...
  fields: {
    id: { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new PrimaryKeySerde(() => bookAdvanceMeta, "id", "id") },
    createdAt: { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("createdAt", "created_at", "timestamp with time zone") },
    updatedAt: { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("updatedAt", "updated_at", "timestamp with time zone") },
    ...
    book: { kind: "m2o", fieldName: "book", fieldIdName: "bookId", required: true, otherMetadata: () => bookMeta, otherFieldName: "advances", serde: new ForeignKeySerde("book", "book_id", () => bookMeta) },
    publisher: { kind: "m2o", fieldName: "publisher", fieldIdName: "publisherId", required: true, otherMetadata: () => publisherMeta, otherFieldName: "bookAdvances", serde: new ForeignKeySerde("publisher", "publisher_id", () => publisherMeta) },
  },
...
export const bookReviewMeta: EntityMetadata<BookReview> = {
  ...
  fields: {
    id: { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new PrimaryKeySerde(() => bookReviewMeta, "id", "id") },
    ...
    createdAt: { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("createdAt", "created_at", "timestamp with time zone") },
    updatedAt: { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("updatedAt", "updated_at", "timestamp with time zone") },
    book: { kind: "m2o", fieldName: "book", fieldIdName: "bookId", required: true, otherMetadata: () => bookMeta, otherFieldName: "reviews", serde: new ForeignKeySerde("book", "book_id", () => bookMeta) },
...
export const commentMeta: EntityMetadata<Comment> = {
  ...
  tableName: "comments",
  fields: {
    id: { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new PrimaryKeySerde(() => commentMeta, "id", "id") },
...
export const criticMeta: EntityMetadata<Critic> = {
  ...
  tableName: "critics",
  fields: {
    id: { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new PrimaryKeySerde(() => criticMeta, "id", "id") },
...
export const imageMeta: EntityMetadata<Image> = {
  ...
  tableName: "images",
  fields: {
    id: { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new PrimaryKeySerde(() => imageMeta, "id", "id") },
    ...
    author: { kind: "m2o", fieldName: "author", fieldIdName: "authorId", required: false, otherMetadata: () => authorMeta, otherFieldName: "image", serde: new ForeignKeySerde("author", "author_id", () => authorMeta) },
    book: { kind: "m2o", fieldName: "book", fieldIdName: "bookId", required: false, otherMetadata: () => bookMeta, otherFieldName: "image", serde: new ForeignKeySerde("book", "book_id", () => bookMeta) },
    publisher: { kind: "m2o", fieldName: "publisher", fieldIdName: "publisherId", required: false, otherMetadata: () => publisherMeta, otherFieldName: "images", serde: new ForeignKeySerde("publisher", "publisher_id", () => publisherMeta) },
  },
  config: imageConfig,
  factory: newImage,
};
...
export const publisherMeta: EntityMetadata<Publisher> = {
  ...
  fields: {
    id: { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new PrimaryKeySerde(() => publisherMeta, "id", "id") },
    name: { kind: "primitive", fieldName: "name", fieldIdName: undefined, derived: false, required: true, protected: false, type: "string", serde: new PrimitiveSerde("name", "name", "character varying") },
...
export const tagMeta: EntityMetadata<Tag> = {
  ...
  tableName: "tags",
  fields: {
    id: { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new PrimaryKeySerde(() => tagMeta, "id", "id") },
    name: { kind: "primitive", fieldName: "name", fieldIdName: undefined, derived: false, required: true, protected: false, type: "string", serde: new PrimitiveSerde("name", "name", "character varying") },
    createdAt: { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("createdAt", "created_at", "timestamp with time zone") },
    updatedAt: { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("updatedAt", "updated_at", "timestamp with time zone") },
