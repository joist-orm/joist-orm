// Generated by joist-codegen (hash=0b5bf7.28438)
...
export const authorStatMeta: EntityMetadata<AuthorStat> = {
  ...
  fields: {
    ...
    "integerNull": { kind: "primitive", fieldName: "integerNull", fieldIdName: undefined, derived: false, required: false, protected: false, type: "number", serde: new PrimitiveSerde("integerNull", "integer_null", "int"), immutable: false },
