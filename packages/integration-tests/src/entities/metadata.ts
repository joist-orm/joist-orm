...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    favoriteShape: { kind: "primitive", fieldName: "favoriteShape", fieldIdName: undefined, derived: false, required: false, protected: false, type: "string", serde: new PrimitiveSerde("favoriteShape", "favorite_shape", "string"), immutable: false },
