// Generated by joist-codegen (hash=fa8df3.31903)
...
export const smallPublisherMeta: EntityMetadata<SmallPublisher> = {
  ...
  fields: { "id": { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new KeySerde("sp", "id", "id", "int"), immutable: true }, "city": { kind: "primitive", fieldName: "city", fieldIdName: undefined, derived: false, required: false, protected: false, type: "string", serde: new PrimitiveSerde("city", "city", "text"), immutable: false } },
  timestampFields: { createdAt: undefined, updatedAt: undefined, deletedAt: undefined },
...
export const allMetadata = [authorMeta, authorStatMeta, bookMeta, bookAdvanceMeta, bookReviewMeta, commentMeta, criticMeta, criticColumnMeta, imageMeta, largePublisherMeta, publisherMeta, smallPublisherMeta, tagMeta];
