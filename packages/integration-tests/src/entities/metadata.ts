...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "search": { kind: "primitive", fieldName: "search", fieldIdName: undefined, derived: "async", required: false, protected: false, type: "string", serde: new PrimitiveSerde("search", "search", "tsvector"), immutable: false },
