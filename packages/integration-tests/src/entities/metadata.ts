...
export const bookMeta: EntityMetadata<Book> = {
  ...
  fields: {
    ...
    "createdAt": { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("createdAt", "created_at", "timestamp with time zone"), immutable: false },
    "updatedAt": { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("updatedAt", "updated_at", "timestamp with time zone"), immutable: false },
    "sequel": { kind: "m2o", fieldName: "sequel", fieldIdName: "sequelId", required: false, otherMetadata: () => bookMeta, otherFieldName: "sequelBook", serde: new KeySerde("b", "sequel", "sequel_id", "int"), immutable: false },
    ...
    "sequelBook": { kind: "o2o", fieldName: "sequelBook", fieldIdName: "sequelBookId", required: false, otherMetadata: () => bookMeta, otherFieldName: "sequel", serde: undefined, immutable: false },
...
export const criticMeta: EntityMetadata<Critic> = {
  ...
  fields: {
    ...
    "createdAt": { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("createdAt", "created_at", "timestamp with time zone"), immutable: false },
    "updatedAt": { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("updatedAt", "updated_at", "timestamp with time zone"), immutable: false },
    "favoriteLargePublisher": { kind: "m2o", fieldName: "favoriteLargePublisher", fieldIdName: "favoriteLargePublisherId", required: false, otherMetadata: () => largePublisherMeta, otherFieldName: "critics", serde: new KeySerde("p", "favoriteLargePublisher", "favorite_large_publisher_id", "int"), immutable: false },
