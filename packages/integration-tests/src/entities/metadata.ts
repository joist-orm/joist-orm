...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "numberOfPublicReviews2": { kind: "primitive", fieldName: "numberOfPublicReviews2", fieldIdName: undefined, derived: "async", required: false, protected: false, type: "number", serde: new PrimitiveSerde("numberOfPublicReviews2", "number_of_public_reviews2", "int"), immutable: false },
