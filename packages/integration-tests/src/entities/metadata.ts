...
export const criticMeta: EntityMetadata<Critic> = {
  ...
  fields: {
    ...
    "createdAt": { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("createdAt", "created_at", "timestamp with time zone"), immutable: false },
    "updatedAt": { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: "Date", serde: new PrimitiveSerde("updatedAt", "updated_at", "timestamp with time zone"), immutable: false },
    "group": { kind: "m2o", fieldName: "group", fieldIdName: "groupId", required: false, otherMetadata: () => publisherGroupMeta, otherFieldName: "critics", serde: new KeySerde("pg", "group", "group_id", "int"), immutable: false },
...
export const largePublisherMeta: EntityMetadata<LargePublisher> = {
  ...
  fields: { "id": { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new KeySerde("p", "id", "id", "int"), immutable: true }, "country": { kind: "primitive", fieldName: "country", fieldIdName: undefined, derived: false, required: false, protected: false, type: "string", serde: new PrimitiveSerde("country", "country", "text"), immutable: false } },
  allFields: {},
...
export const publisherMeta: EntityMetadata<Publisher> = {
  ...
  fields: {
    ...
    "group": { kind: "m2o", fieldName: "group", fieldIdName: "groupId", required: false, otherMetadata: () => publisherGroupMeta, otherFieldName: "publishers", serde: new KeySerde("pg", "group", "group_id", "int"), immutable: false },
    ...
    "tags": { kind: "m2m", fieldName: "tags", fieldIdName: "tagIds", required: false, otherMetadata: () => tagMeta, otherFieldName: "publishers", serde: undefined, immutable: false },
  },
  allFields: {},
  timestampFields: { createdAt: "createdAt", updatedAt: "updatedAt", deletedAt: undefined },
...
export const tagMeta: EntityMetadata<Tag> = {
  ...
  fields: {
    ...
    "publishers": { kind: "m2m", fieldName: "publishers", fieldIdName: "publisherIds", required: false, otherMetadata: () => publisherMeta, otherFieldName: "tags", serde: undefined, immutable: false },
  },
  allFields: {},
  timestampFields: { createdAt: "createdAt", updatedAt: "updatedAt", deletedAt: undefined },
  config: tagConfig,
