...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "currentDraftBook": {
      ...
      fieldIdName: "currentDraftBookId",
      required: false,
      otherMetadata: () => bookMeta,
      otherFieldName: "currentDraftAuthor",
      serde: new KeySerde("b", "currentDraftBook", "current_draft_book_id", "int"),
      immutable: false,
    },
...
export const bookMeta: EntityMetadata<Book> = {
  ...
  fields: {
    ...
    "currentDraftAuthor": {
      kind: "o2o",
      fieldName: "currentDraftAuthor",
      fieldIdName: "currentDraftAuthorId",
      required: false,
      otherMetadata: () => authorMeta,
      otherFieldName: "currentDraftBook",
      serde: undefined,
      immutable: false,
    },
