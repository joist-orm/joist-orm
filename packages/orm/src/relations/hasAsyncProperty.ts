...
export class AsyncPropertyImpl<T extends Entity, H extends LoadHint<T>, V>
  implements AsyncProperty<T, V>, MaybeReactiveProperty
{
  ...
  get toExpandedReactiveHint(): ReactiveHint<T> | undefined {
