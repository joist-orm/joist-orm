...
import { Author, authorMeta, Book, bookMeta, EntityManager, newBook } from "../entities.js";
import type { AuthorId, AuthorOrder, Entity } from "../entities.js";
...
export abstract class BookCodegen extends BaseEntity<EntityManager, string> implements Entity {
  ...
  toJSON(): object;
  toJSON<const H extends NestedJsonHint<Book>>(hint: H): Promise<JsonPayload<Book, H>>;
