...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    delete: {
      ...
      protected: false,
      type: "boolean",
      serde: new PrimitiveSerde("delete", "delete", "boolean"),
      immutable: false,
    },
    createdAt: {
      kind: "primitive",
      ...
      protected: false,
      type: Date,
      serde: new DateSerde("createdAt", "createdAt", "timestamp with time zone"),
      immutable: false,
    },
    updatedAt: {
      kind: "primitive",
      ...
      protected: false,
      type: Date,
      serde: new DateSerde("updatedAt", "updatedAt", "timestamp with time zone"),
      immutable: false,
    },
    books: {
      kind: "o2m",
...
export const bookMeta: EntityMetadata<Book> = {
  ...
  fields: {
    ...
    author: {
      ...
      serde: new KeySerde("a", "author", "authorId", "int"),
      immutable: false,
    },
  },
  allFields: {},
