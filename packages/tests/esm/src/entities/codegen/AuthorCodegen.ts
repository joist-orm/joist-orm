...
export interface AuthorColumns {
  ...
  "createdAt": { type: Temporal.ZonedDateTime; nullable: false; insert: "optional"; update: true };
  "updatedAt": { type: Temporal.ZonedDateTime; nullable: false; insert: "optional"; update: true };
