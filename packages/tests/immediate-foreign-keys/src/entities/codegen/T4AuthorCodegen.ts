...
export const t4AuthorScope = newScopeFn<T4Author>("T4Author");
...
export abstract class T4AuthorCodegen extends BaseEntity<EntityManager, number> implements Entity {
  ...
  readonly t4Books: Collection<T4Author, T4Book> = hasMany();
  readonly favoriteBook: ManyToOneReference<T4Author, T4Book, never> = hasOne();
