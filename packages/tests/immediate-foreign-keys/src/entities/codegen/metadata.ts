...
export const t1AuthorMeta: EntityMetadata<T1Author> = {
  ...
  fields: {
    id: {
      ...
      required: true,
      serde: new KeySerde("ta", "id", "id", "int"),
      immutable: true,
    },
    firstName: {
      kind: "primitive",
    ...
    t1Books: {
      kind: "o2m",
      fieldName: "t1Books",
      fieldIdName: "t1BookIds",
      required: false,
      otherMetadata: () => t1BookMeta,
...
export const t1BookMeta: EntityMetadata<T1Book> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("tb", "id", "id", "int"),
      immutable: true,
    },
    title: {
      kind: "primitive",
    ...
    author: {
      ...
      derived: false,
      required: true,
      otherMetadata: () => t1AuthorMeta,
      otherFieldName: "t1Books",
      serde: new KeySerde("ta", "author", "author_id", "int"),
      immutable: false,
    },
  },
  allFields: {},
...
export const t2AuthorMeta: EntityMetadata<T2Author> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("t2Author", "id", "id", "int"),
      immutable: true,
    },
    firstName: {
      kind: "primitive",
    ...
    favoriteBook: {
      ...
      derived: false,
      required: false,
      otherMetadata: () => t2BookMeta,
      otherFieldName: "t2Authors",
      serde: new KeySerde("t2Book", "favoriteBook", "favorite_book_id", "int"),
      immutable: false,
    },
    t2Books: {
      kind: "o2m",
      fieldName: "t2Books",
      fieldIdName: "t2BookIds",
      required: false,
      otherMetadata: () => t2BookMeta,
      otherFieldName: "author",
      serde: undefined,
...
export const t2BookMeta: EntityMetadata<T2Book> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("t2Book", "id", "id", "int"),
      immutable: true,
    },
    title: {
      kind: "primitive",
    ...
    author: {
      ...
      derived: false,
      required: true,
      otherMetadata: () => t2AuthorMeta,
      otherFieldName: "t2Books",
      serde: new KeySerde("t2Author", "author", "author_id", "int"),
      immutable: false,
    },
    t2Authors: {
      kind: "o2m",
      fieldName: "t2Authors",
      fieldIdName: "t2AuthorIds",
      required: false,
      otherMetadata: () => t2AuthorMeta,
...
export const t3AuthorMeta: EntityMetadata<T3Author> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("t3Author", "id", "id", "int"),
      immutable: true,
    },
    firstName: {
      kind: "primitive",
    ...
    favoriteBook: {
      ...
      derived: false,
      required: true,
      otherMetadata: () => t3BookMeta,
      otherFieldName: "t3Authors",
      serde: new KeySerde("t3Book", "favoriteBook", "favorite_book_id", "int"),
      immutable: false,
    },
    t3Books: {
      kind: "o2m",
      fieldName: "t3Books",
      fieldIdName: "t3BookIds",
      required: false,
      otherMetadata: () => t3BookMeta,
      otherFieldName: "author",
      serde: undefined,
...
export const t3BookMeta: EntityMetadata<T3Book> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("t3Book", "id", "id", "int"),
      immutable: true,
    },
    title: {
      kind: "primitive",
    ...
    author: {
      ...
      derived: false,
      required: true,
      otherMetadata: () => t3AuthorMeta,
      otherFieldName: "t3Books",
      serde: new KeySerde("t3Author", "author", "author_id", "int"),
      immutable: false,
    },
    t3Authors: {
      kind: "o2m",
      fieldName: "t3Authors",
      fieldIdName: "t3AuthorIds",
      required: false,
      otherMetadata: () => t3AuthorMeta,
      otherFieldName: "favoriteBook",
      serde: undefined,
...
export const t4AuthorMeta: EntityMetadata<T4Author> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("t4Author", "id", "id", "int"),
      immutable: true,
    },
    firstName: {
      kind: "primitive",
    ...
    favoriteBook: {
      ...
      derived: false,
      required: true,
      otherMetadata: () => t4BookMeta,
      otherFieldName: "t4Authors",
      serde: new KeySerde("t4Book", "favoriteBook", "favorite_book_id", "int"),
      immutable: false,
    },
    t4Books: {
      kind: "o2m",
      fieldName: "t4Books",
      fieldIdName: "t4BookIds",
      required: false,
      otherMetadata: () => t4BookMeta,
      otherFieldName: "author",
      serde: undefined,
...
export const t4BookMeta: EntityMetadata<T4Book> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("t4Book", "id", "id", "int"),
      immutable: true,
    },
    title: {
      kind: "primitive",
    ...
    author: {
      ...
      derived: false,
      required: true,
      otherMetadata: () => t4AuthorMeta,
      otherFieldName: "t4Books",
      serde: new KeySerde("t4Author", "author", "author_id", "int"),
      immutable: false,
    },
    t4Authors: {
      kind: "o2m",
      fieldName: "t4Authors",
      fieldIdName: "t4AuthorIds",
      required: false,
      otherMetadata: () => t4AuthorMeta,
      otherFieldName: "favoriteBook",
      serde: undefined,
...
export const t5AuthorMeta: EntityMetadata<T5Author> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("t5Author", "id", "id", "int"),
      immutable: true,
    },
    firstName: {
      kind: "primitive",
    ...
    t5Books: {
      kind: "o2m",
      fieldName: "t5Books",
      fieldIdName: "t5BookIds",
      required: false,
      otherMetadata: () => t5BookMeta,
      otherFieldName: "author",
      serde: undefined,
      immutable: false,
    },
...
export const t5BookMeta: EntityMetadata<T5Book> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("t5Book", "id", "id", "int"),
      immutable: true,
    },
    title: {
      kind: "primitive",
    ...
    author: {
      ...
      derived: false,
      required: true,
      otherMetadata: () => t5AuthorMeta,
      otherFieldName: "t5Books",
      serde: new KeySerde("t5Author", "author", "author_id", "int"),
      immutable: false,
    },
    reviews: {
      kind: "o2m",
      ...
      required: false,
      otherMetadata: () => t5BookReviewMeta,
      otherFieldName: "book",
      serde: undefined,
      immutable: false,
    },
...
export const t5BookReviewMeta: EntityMetadata<T5BookReview> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("tbr", "id", "id", "int"),
      immutable: true,
    },
    title: {
      kind: "primitive",
    ...
    book: {
      ...
      serde: new KeySerde("t5Book", "book", "book_id", "int"),
      immutable: false,
    },
  },
  allFields: {},
