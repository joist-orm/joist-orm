    ...
    it("sees primitive sets", async () => {
      ...
      expect(output).toMatchInlineSnapshot(`
       [
         ...
         "a#1 created, queuing a#1.Author.ts:558↩",
         ...
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.Author.ts:558 to recalc↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.bookComments to recalc↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         ...
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(AuthorCodegen.ts:408) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:439) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:461) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:468) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:475) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:480) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:488) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addCycleRule(Author.ts:494) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.menteesRecursive paths, found 0 Author.addCycleRule(Author.ts:494) to validate↩",
         "  Walked 1 Author.menteesRecursive paths, found 0 Author.addCycleRule(Author.ts:494) to validate↩",
         "  Walked 1 Author.books paths, found 0 Book.addRule(Book.ts:52) to validate↩",
         "  Walked 1 Author.books paths, found 0 Book.addRule(Book.ts:63) to validate↩",
