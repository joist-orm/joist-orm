    ...
    it("sees primitive sets", async () => {
      ...
      expect(output).toMatchInlineSnapshot(`
       [
         ...
         "  Walked 1 Author.publisher paths, found 0 Publisher.addRule(Publisher.ts:191) to validate↩",
         "  Walked 1 Author.publisher paths, found 0 Publisher.addRule(Publisher.ts:198) to validate↩",
         "  Walked 1 Author.publisher paths, found 0 Publisher.addRule(Publisher.ts:206) to validate↩",
