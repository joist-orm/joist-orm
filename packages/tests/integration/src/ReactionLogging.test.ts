    ...
    it("sees primitive sets", async () => {
      ...
      expect(output).toMatchInlineSnapshot(`
       [
         ...
         "a#1 created, queuing a#1.imageFileName↩",
         ...
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.deleteTag to recalc↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         ...
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.Author.ts:597 to recalc↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.bookComments to recalc↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         ...
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.imageFileName to recalc↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         ...
         "  Loading 27 actions... (em.entities=1)↩",
         "    Author.direct -> [ a#1 ]↩",
         ...
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(AuthorCodegen.ts:433) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:478) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:500) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:507) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:514) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:519) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:527) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addCycleRule(Author.ts:533) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.menteesRecursive paths, found 0 Author.addCycleRule(Author.ts:533) to validate↩",
         "  Walked 1 Author.menteesRecursive paths, found 0 Author.addCycleRule(Author.ts:533) to validate↩",
         "  Walked 1 Author.books paths, found 0 Book.addRule(Book.ts:62) to validate↩",
         "  Walked 1 Author.books paths, found 0 Book.addRule(Book.ts:73) to validate↩",
         "  Walked 1 Author.publisher paths, found 0 Publisher.addRule(Publisher.ts:204) to validate↩",
         "  Walked 1 Author.publisher paths, found 0 Publisher.addRule(Publisher.ts:211) to validate↩",
         "  Walked 1 Author.publisher paths, found 0 Publisher.addRule(Publisher.ts:219) to validate↩",
         "  Walked 1 Author.publisher@SmallPublisher paths, found 0 SmallPublisher.addRule(SmallPublisher.ts:87) to validate↩",
