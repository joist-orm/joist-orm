    ...
    it("sees primitive sets", async () => {
      ...
      expect(output).toMatchInlineSnapshot(`
       [
         ...
         "a#1 created, queuing a#1.Author.ts:559↩",
         ...
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.Author.ts:559 to recalc↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.bookComments to recalc↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         ...
         "  Loading 26 actions... (em.entities=1)↩",
         "    Author.direct -> [ a#1 ]↩",
         ...
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(AuthorCodegen.ts:425) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:448) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:470) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:477) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:484) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:489) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addRule(Author.ts:497) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.(self) paths, found 1 Author.addCycleRule(Author.ts:503) to validate↩",
         "    [ a#1 ] -> [ a#1 ]↩",
         "  Walked 1 Author.menteesRecursive paths, found 0 Author.addCycleRule(Author.ts:503) to validate↩",
         "  Walked 1 Author.menteesRecursive paths, found 0 Author.addCycleRule(Author.ts:503) to validate↩",
