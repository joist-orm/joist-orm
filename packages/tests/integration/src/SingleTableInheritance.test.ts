...
describe("SingleTableInheritance", () => {
  ...
  it("reports the right properties", () => {
    expect(Object.keys(getProperties(Task.metadata))).toMatchEntity([
      "typeDetails",
      "isOld",
      "isNew",
      "taskTaskItems",
    ...
    expect(Object.keys(getProperties(TaskNew.metadata))).toMatchEntity([
      "newTaskTaskItems",
    ...
    expect(Object.keys(getProperties(TaskOld.metadata))).toMatchEntity([
      "commentParentInfo",
      "comments",
      "oldTaskTaskItems",
      "tasks",
