...
export interface AdminUserFields extends UserFields {
  ...
  role: { kind: "primitive"; type: string; unique: false; nullable: false; derived: false };
}
...
export abstract class AdminUserCodegen extends User implements Entity {
   ...
   * @see {@link https://joist-orm.io/docs/features/partial-update-apis | Partial Update APIs} on the Joist docs
   */
  setDeepPartial(opts: DeepPartialOrNull<AdminUser>): Promise<void> {
    return updatePartial(this as any as AdminUser, opts);
  }
