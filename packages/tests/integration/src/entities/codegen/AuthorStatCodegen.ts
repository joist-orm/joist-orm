...
import { type AuthorStat, authorStatMeta, type Entity, EntityManager, newAuthorStat } from "../entities";
...
export interface AuthorStatScopes {
}

export type AuthorStatScope = Scope<AuthorStat, AuthorStatScopes>;
