...
import type { ChildId, ChildItemId, ChildOrder, Entity, ParentGroupId, ParentGroupOrder } from "../entities";
...
export abstract class ChildGroupCodegen extends BaseEntity<EntityManager, string> implements Entity {
  ...
  getFieldValue<K extends keyof ChildGroupFields>(key: K): FieldType<ChildGroupFields, K> {
    return getField(this as any, key);
  }

  setFieldValue<K extends keyof SettableFields<ChildGroupFields> & keyof ChildGroupFields>(
    key: K,
    value: FieldType<ChildGroupFields, K>,
  ): void {
