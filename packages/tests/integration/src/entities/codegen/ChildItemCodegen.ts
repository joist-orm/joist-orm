...
export interface ChildItemScopes {
}

export type ChildItemScope = Scope<ChildItem, ChildItemScopes>;
...
export abstract class ChildItemCodegen extends BaseEntity<EntityManager, string> implements Entity {
  ...
  readonly childGroup: ManyToOneReference<ChildItem, ChildGroup, never> = hasOne();
  readonly parentItem: ManyToOneReference<ChildItem, ParentItem, never> = hasOne();
