...
export interface CommentFields {
  ...
  parentTaggedId: { kind: "primitive"; type: string; unique: false; nullable: true; derived: true };
  parentTags: { kind: "primitive"; type: string; unique: false; nullable: false; derived: true };
  text: { kind: "primitive"; type: string; unique: false; nullable: true; derived: false };
  ...
  user: { kind: "m2o"; type: User; nullable: true; derived: false };
