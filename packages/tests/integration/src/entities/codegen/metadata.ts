import { BigIntSerde, configureMetadata, CustomSerdeAdapter, DecimalToNumberSerde, EntityManager as EntityManager1, EnumArrayFieldSerde, EnumFieldSerde, JsonSerde, KeySerde, PlainDateSerde, PolymorphicKeySerde, PrimitiveSerde, SuperstructSerde, ZodSerde, ZonedDateTimeSerde } from "joist-orm";
...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "graduated": { kind: "primitive", fieldName: "graduated", fieldIdName: undefined, derived: false, required: false, protected: false, type: Temporal.PlainDate, serde: new PlainDateSerde("graduated", "graduated", "date"), immutable: false },
...
export const publisherMeta: EntityMetadata<Publisher> = {
  ...
  fields: {
    ...
    "type": { kind: "enum", fieldName: "type", fieldIdName: undefined, required: true, derived: false, enumDetailType: PublisherTypes, serde: new EnumFieldSerde("type", "type_id", "int", PublisherTypes), immutable: false, default: "schema" },
