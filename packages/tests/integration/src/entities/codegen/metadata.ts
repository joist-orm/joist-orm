...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "imageTagNames": { kind: "primitive", fieldName: "imageTagNames", fieldIdName: undefined, derived: "async", required: false, protected: false, type: "string", serde: new PrimitiveSerde("imageTagNames", "image_tag_names", "text"), immutable: false },
...
export const imageMeta: EntityMetadata<Image> = {
  ...
  fields: {
    ...
    "tags": { kind: "m2m", fieldName: "tags", fieldIdName: "tagIds", required: false, otherMetadata: () => tagMeta, otherFieldName: "images", serde: undefined, immutable: false, joinTableName: "image_to_tags", columnNames: ["image_id", "tag_id"] },
  },
  allFields: {},
  orderBy: undefined,
  timestampFields: { createdAt: "createdAt", updatedAt: "updatedAt", deletedAt: undefined },
...
export const tagMeta: EntityMetadata<Tag> = {
  ...
  fields: {
    ...
    "images": { kind: "m2m", fieldName: "images", fieldIdName: "imageIds", required: false, otherMetadata: () => imageMeta, otherFieldName: "tags", serde: undefined, immutable: false, joinTableName: "image_to_tags", columnNames: ["tag_id", "image_id"] },
