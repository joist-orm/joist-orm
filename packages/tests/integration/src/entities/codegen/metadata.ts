...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "books": { kind: "o2m", fieldName: "books", fieldIdName: "bookIds", required: false, otherMetadata: () => bookMeta, otherFieldName: "author", serde: undefined, immutable: false, orderBy: { field: "order", direction: "ASC" } },
    "reviewerBooks": { kind: "o2m", fieldName: "reviewerBooks", fieldIdName: "reviewerBookIds", required: false, otherMetadata: () => bookMeta, otherFieldName: "reviewer", serde: undefined, immutable: false, orderBy: { field: "title", direction: "ASC" } },
...
export const bookMeta: EntityMetadata<Book> = {
  ...
  fields: {
    ...
    "reviews": { kind: "o2m", fieldName: "reviews", fieldIdName: "reviewIds", required: false, otherMetadata: () => bookReviewMeta, otherFieldName: "book", serde: undefined, immutable: false, orderBy: { field: "critic", direction: "ASC" } },
    "comments": { kind: "o2m", fieldName: "comments", fieldIdName: "commentIds", required: false, otherMetadata: () => commentMeta, otherFieldName: "parent", serde: undefined, immutable: false },
...
export const commentMeta: EntityMetadata<Comment> = {
  ...
  fields: {
    ...
    "books": { kind: "o2m", fieldName: "books", fieldIdName: "bookIds", required: false, otherMetadata: () => bookMeta, otherFieldName: "randomComment", serde: undefined, immutable: false, orderBy: { field: "title", direction: "ASC" } },
...
export const criticMeta: EntityMetadata<Critic> = {
  ...
  fields: {
    ...
    "bookReviews": { kind: "o2m", fieldName: "bookReviews", fieldIdName: "bookReviewIds", required: false, otherMetadata: () => bookReviewMeta, otherFieldName: "critic", serde: undefined, immutable: false, orderBy: { field: "critic", direction: "ASC" } },
...
export const publisherMeta: EntityMetadata<Publisher> = {
  ...
  fields: {
    ...
    "authors": { kind: "o2m", fieldName: "authors", fieldIdName: "authorIds", required: false, otherMetadata: () => authorMeta, otherFieldName: "publisher", serde: undefined, immutable: false, orderBy: { field: "numberOfBooks", direction: "ASC" } },
