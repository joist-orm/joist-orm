...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "nickNames": { kind: "primitive", fieldName: "nickNames", fieldIdName: undefined, derived: false, required: false, protected: false, type: "string", serde: new PrimitiveSerde("nickNames", "nick_names", "character varying[]", true, true), immutable: false, default: "config", sanitize: false },
    "nickNamesUpper": { kind: "primitive", fieldName: "nickNamesUpper", fieldIdName: undefined, derived: "async", required: false, protected: false, type: "string", serde: new PrimitiveSerde("nickNamesUpper", "nick_names_upper", "character varying[]", true, true), immutable: false, sanitize: false },
    ...
    "menteeNames": { kind: "primitive", fieldName: "menteeNames", fieldIdName: undefined, derived: "async", required: false, protected: false, type: "string", serde: new PrimitiveSerde("menteeNames", "mentee_names", "text"), immutable: false },
    ...
    "mentorsClosure": { kind: "m2m", fieldName: "mentorsClosure", fieldIdName: "mentorsClosureIds", required: false, derived: "otherSide", otherMetadata: () => authorMeta, otherFieldName: "menteesClosure", serde: undefined, immutable: false, joinTableName: "author_to_mentees_closure", columnNames: ["mentee_id", "mentor_id"] },
    "menteesClosure": { kind: "m2m", fieldName: "menteesClosure", fieldIdName: "menteesClosureIds", required: false, derived: "async", otherMetadata: () => authorMeta, otherFieldName: "mentorsClosure", serde: undefined, immutable: false, joinTableName: "author_to_mentees_closure", columnNames: ["mentor_id", "mentee_id"] },
    "tags": { kind: "m2m", fieldName: "tags", fieldIdName: "tagIds", required: false, derived: false, otherMetadata: () => tagMeta, otherFieldName: "authors", serde: undefined, immutable: false, joinTableName: "authors_to_tags", columnNames: ["author_id", "tag_id"] },
    "bestReviews": { kind: "m2m", fieldName: "bestReviews", fieldIdName: "bestReviewIds", required: false, derived: "async", otherMetadata: () => bookReviewMeta, otherFieldName: "bestReviewAuthors", serde: undefined, immutable: false, joinTableName: "authors_to_best_reviews", columnNames: ["author_id", "book_review_id"] },
...
export const bookMeta: EntityMetadata<Book> = {
  ...
  fields: {
    ...
    "tags": { kind: "m2m", fieldName: "tags", fieldIdName: "tagIds", required: false, derived: false, otherMetadata: () => tagMeta, otherFieldName: "books", serde: undefined, immutable: false, joinTableName: "books_to_tags", columnNames: ["book_id", "tag_id"] },
...
export const bookReviewMeta: EntityMetadata<BookReview> = {
  ...
  fields: {
    ...
    "isTestChain": { kind: "primitive", fieldName: "isTestChain", fieldIdName: undefined, derived: "async", required: false, protected: false, type: "boolean", serde: new PrimitiveSerde("isTestChain", "is_test_chain", "boolean"), immutable: false },
    "createdAt": { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: Date, serde: new DateSerde("createdAt", "created_at", "timestamp with time zone"), immutable: false },
    "updatedAt": { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: Date, serde: new DateSerde("updatedAt", "updated_at", "timestamp with time zone"), immutable: false },
...
export const commentMeta: EntityMetadata<Comment> = {
  ...
  fields: {
    ...
    "likedByUsers": { kind: "m2m", fieldName: "likedByUsers", fieldIdName: "likedByUserIds", required: false, derived: false, otherMetadata: () => userMeta, otherFieldName: "likedComments", serde: undefined, immutable: false, joinTableName: "users_to_comments", columnNames: ["comment_id", "liked_by_user_id"] },
    "parent": {
      kind: "poly",
      fieldName: "parent",
...
export const publisherMeta: EntityMetadata<Publisher> = {
  ...
  fields: {
    ...
    "authors": { kind: "o2m", fieldName: "authors", fieldIdName: "authorIds", required: false, otherMetadata: () => authorMeta, otherFieldName: "publisher", otherColumnName: "publisher_id", serde: undefined, immutable: false, orderBy: { field: "numberOfBooks", direction: "ASC" } },
    ...
    "tags": { kind: "m2m", fieldName: "tags", fieldIdName: "tagIds", required: false, derived: false, otherMetadata: () => tagMeta, otherFieldName: "publishers", serde: undefined, immutable: false, joinTableName: "publishers_to_tags", columnNames: ["publisher_id", "tag_id"] },
    "tasks": { kind: "m2m", fieldName: "tasks", fieldIdName: "taskIds", required: false, derived: false, otherMetadata: () => taskOldMeta, otherFieldName: "publishers", serde: undefined, immutable: false, joinTableName: "tasks_to_publishers", columnNames: ["publisher_id", "task_id"] },
  },
  allFields: {},
  orderBy: undefined,
  timestampFields: { createdAt: "createdAt", updatedAt: "updatedAt", deletedAt: "deletedAt" },
...
export const tagMeta: EntityMetadata<Tag> = {
  ...
  fields: {
    ...
    "createdAt": { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: Date, serde: new DateSerde("createdAt", "created_at", "timestamp with time zone"), immutable: false },
    "updatedAt": { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: Date, serde: new DateSerde("updatedAt", "updated_at", "timestamp with time zone"), immutable: false },
    "authors": { kind: "m2m", fieldName: "authors", fieldIdName: "authorIds", required: false, derived: false, otherMetadata: () => authorMeta, otherFieldName: "tags", serde: undefined, immutable: false, joinTableName: "authors_to_tags", columnNames: ["tag_id", "author_id"] },
    "books": { kind: "m2m", fieldName: "books", fieldIdName: "bookIds", required: false, derived: false, otherMetadata: () => bookMeta, otherFieldName: "tags", serde: undefined, immutable: false, joinTableName: "books_to_tags", columnNames: ["tag_id", "book_id"] },
    "bookReviews": { kind: "m2m", fieldName: "bookReviews", fieldIdName: "bookReviewIds", required: false, derived: false, otherMetadata: () => bookReviewMeta, otherFieldName: "tags", serde: undefined, immutable: false, joinTableName: "book_reviews_to_tags", columnNames: ["tag_id", "book_review_id"] },
    "publishers": { kind: "m2m", fieldName: "publishers", fieldIdName: "publisherIds", required: false, derived: false, otherMetadata: () => publisherMeta, otherFieldName: "tags", serde: undefined, immutable: false, joinTableName: "publishers_to_tags", columnNames: ["tag_id", "publisher_id"] },
    "tasks": { kind: "m2m", fieldName: "tasks", fieldIdName: "taskIds", required: false, derived: false, otherMetadata: () => taskMeta, otherFieldName: "tags", serde: undefined, immutable: false, joinTableName: "task_to_tags", columnNames: ["tag_id", "task_id"] },
  },
  allFields: {},
  orderBy: undefined,
  timestampFields: { createdAt: "createdAt", updatedAt: "updatedAt", deletedAt: undefined },
...
export const taskMeta: EntityMetadata<Task> = {
  ...
  fields: {
    ...
    "tags": { kind: "m2m", fieldName: "tags", fieldIdName: "tagIds", required: false, derived: false, otherMetadata: () => tagMeta, otherFieldName: "tasks", serde: undefined, immutable: false, joinTableName: "task_to_tags", columnNames: ["task_id", "tag_id"] },
  },
  allFields: {},
  orderBy: undefined,
  timestampFields: { createdAt: "createdAt", updatedAt: "updatedAt", deletedAt: "deletedAt" },
...
export const userMeta: EntityMetadata<User> = {
  ...
  fields: {
    ...
    "password": { kind: "primitive", fieldName: "password", fieldIdName: undefined, derived: false, required: false, protected: false, type: "string", serde: new CustomSerdeAdapter("password", "password", "character varying", PasswordValueSerde), immutable: false, sanitize: false },
    "bio": { kind: "primitive", fieldName: "bio", fieldIdName: undefined, derived: false, required: true, protected: false, type: "string", serde: new PrimitiveSerde("bio", "bio", "character varying"), immutable: false, default: "schema", sanitize: false },
...
export const taskOldMeta: EntityMetadata<TaskOld> = {
  ...
  fields: {
    ...
    "publishers": { kind: "m2m", fieldName: "publishers", fieldIdName: "publisherIds", required: false, derived: false, otherMetadata: () => publisherMeta, otherFieldName: "tasks", serde: undefined, immutable: false, joinTableName: "tasks_to_publishers", columnNames: ["task_id", "publisher_id"] },
  },
  allFields: {},
  orderBy: undefined,
  timestampFields: undefined,
