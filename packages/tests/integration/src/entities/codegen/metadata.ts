...
export const publisherMeta: EntityMetadata<Publisher> = {
  ...
  fields: {
    ...
    "favoriteAuthor": { kind: "m2o", fieldName: "favoriteAuthor", fieldIdName: "favoriteAuthorId", derived: "async", required: false, otherMetadata: () => authorMeta, otherFieldName: "publishers", serde: new KeySerde("a", "favoriteAuthor", "favorite_author_id", "int"), immutable: false },
