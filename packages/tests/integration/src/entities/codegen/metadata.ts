...
export const authorMeta: EntityMetadata<Author> = {
  ...
  allFields: {},
  recursiveRelations: { "mentorsRecursive": { "fieldName": "mentorsRecursive", "kind": "parents", "relationName": "mentor", "otherFieldName": "menteesRecursive" }, "menteesRecursive": { "fieldName": "menteesRecursive", "kind": "children", "relationName": "mentees", "otherFieldName": "mentorsRecursive" } },
  orderBy: undefined,
...
export const bookMeta: EntityMetadata<Book> = {
  ...
  allFields: {},
  recursiveRelations: { "prequelsRecursive": { "fieldName": "prequelsRecursive", "kind": "parents", "relationName": "prequel", "otherFieldName": "sequelsRecursive" }, "sequelsRecursive": { "fieldName": "sequelsRecursive", "kind": "children", "relationName": "sequel", "otherFieldName": "prequelsRecursive" } },
  orderBy: "title",
  timestampFields: { createdAt: "createdAt", updatedAt: "updatedAt", deletedAt: "deletedAt" },
  config: bookConfig,
  factory: newBook,
...
export const employeeMeta: EntityMetadata<Employee> = {
  ...
  allFields: {},
  recursiveRelations: { "managersRecursive": { "fieldName": "managersRecursive", "kind": "parents", "relationName": "manager", "otherFieldName": "reportsRecursive" }, "reportsRecursive": { "fieldName": "reportsRecursive", "kind": "children", "relationName": "reports", "otherFieldName": "managersRecursive" } },
  orderBy: undefined,
  timestampFields: { createdAt: "createdAt", updatedAt: "updatedAt", deletedAt: undefined },
...
export const taskMeta: EntityMetadata<Task> = {
  ...
  allFields: {},
  recursiveRelations: { "copiedFromsRecursive": { "fieldName": "copiedFromsRecursive", "kind": "parents", "relationName": "copiedFrom", "otherFieldName": "copiedToRecursive" }, "copiedToRecursive": { "fieldName": "copiedToRecursive", "kind": "children", "relationName": "copiedTo", "otherFieldName": "copiedFromsRecursive" } },
  orderBy: undefined,
  timestampFields: { createdAt: "createdAt", updatedAt: "updatedAt", deletedAt: "deletedAt" },
  config: taskConfig,
  factory: newTask,
...
export const userMeta: EntityMetadata<User> = {
  ...
  allFields: {},
  recursiveRelations: { "parentsRecursive": { "fieldName": "parentsRecursive", "kind": "m2m", "relationName": "parents", "otherFieldName": "childrenRecursive" }, "childrenRecursive": { "fieldName": "childrenRecursive", "kind": "m2m", "relationName": "children", "otherFieldName": "parentsRecursive" } },
  orderBy: undefined,
  timestampFields: { createdAt: "createdAt", updatedAt: "updatedAt", deletedAt: undefined },
  config: userConfig,
  factory: newUser,
...
export const taskOldMeta: EntityMetadata<TaskOld> = {
  ...
  allFields: {},
  recursiveRelations: {
    "parentOldTasksRecursive": { "fieldName": "parentOldTasksRecursive", "kind": "parents", "relationName": "parentOldTask", "otherFieldName": "tasksRecursive" },
    "tasksRecursive": { "fieldName": "tasksRecursive", "kind": "children", "relationName": "tasks", "otherFieldName": "parentOldTasksRecursive" },
    "copiedFromsRecursive": { "fieldName": "copiedFromsRecursive", "kind": "parents", "relationName": "copiedFrom", "otherFieldName": "copiedToRecursive" },
    "copiedToRecursive": { "fieldName": "copiedToRecursive", "kind": "children", "relationName": "copiedTo", "otherFieldName": "copiedFromsRecursive" },
  },
  orderBy: undefined,
  timestampFields: undefined,
