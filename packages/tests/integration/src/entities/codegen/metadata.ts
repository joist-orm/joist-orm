...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "nickNames": { kind: "primitive", fieldName: "nickNames", fieldIdName: undefined, derived: false, required: false, protected: false, type: "string", serde: new PrimitiveSerde("nickNames", "nick_names", "character varying[]", true), immutable: false, default: "config", sanitize: false },
    "nickNamesUpper": { kind: "primitive", fieldName: "nickNamesUpper", fieldIdName: undefined, derived: "async", required: false, protected: false, type: "string", serde: new PrimitiveSerde("nickNamesUpper", "nick_names_upper", "character varying[]", true), immutable: false, sanitize: false },
