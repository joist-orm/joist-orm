...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "favoriteColors": { kind: "enum", fieldName: "favoriteColors", fieldIdName: undefined, required: false, derived: false, enumDetailType: Colors, serde: new EnumArrayFieldSerde("favoriteColors", "favorite_colors", "int[]", Colors), immutable: false },
...
export const bookMeta: EntityMetadata<Book> = {
  ...
  fields: {
    ...
    "notes": { kind: "primitive", fieldName: "notes", fieldIdName: undefined, derived: false, required: true, protected: false, type: "string", serde: new PrimitiveSerde("notes", "notes", "text"), immutable: false, hasConfigDefault: true },
...
export const publisherMeta: EntityMetadata<Publisher> = {
  ...
  fields: {
    ...
    "type": { kind: "enum", fieldName: "type", fieldIdName: undefined, required: true, derived: false, enumDetailType: PublisherTypes, serde: new EnumFieldSerde("type", "type_id", "int", PublisherTypes), immutable: false },
