...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "nickNames": { kind: "primitive", fieldName: "nickNames", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "string", serde: new PrimitiveSerde("nickNames", "nick_names", "character varying[]", true), immutable: false, default: "config" },
    ...
    "favoriteColors": { kind: "enum", fieldName: "favoriteColors", fieldIdName: undefined, required: false, derived: "default", enumDetailType: Colors, serde: new EnumArrayFieldSerde("favoriteColors", "favorite_colors", "int[]", Colors), immutable: false, default: "schema" },
...
export const authorStatMeta: EntityMetadata<AuthorStat> = {
  ...
  fields: {
    ...
    "smallserial": { kind: "primitive", fieldName: "smallserial", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "number", serde: new PrimitiveSerde("smallserial", "smallserial", "smallint"), immutable: false, default: "schema" },
    "serial": { kind: "primitive", fieldName: "serial", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "number", serde: new PrimitiveSerde("serial", "serial", "int"), immutable: false, default: "schema" },
    "bigserial": { kind: "primitive", fieldName: "bigserial", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "bigint", serde: new BigIntSerde("bigserial", "bigserial"), immutable: false, default: "schema" },
...
export const bookMeta: EntityMetadata<Book> = {
  ...
  fields: {
    ...
    "order": { kind: "primitive", fieldName: "order", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "number", serde: new PrimitiveSerde("order", "order", "int"), immutable: false, default: "config" },
    "notes": { kind: "primitive", fieldName: "notes", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "string", serde: new PrimitiveSerde("notes", "notes", "text"), immutable: false, default: "config" },
    ...
    "authorsNickNames": { kind: "primitive", fieldName: "authorsNickNames", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "string", serde: new PrimitiveSerde("authorsNickNames", "authors_nick_names", "text"), immutable: false, default: "config" },
    "search": { kind: "primitive", fieldName: "search", fieldIdName: undefined, derived: "async", required: false, protected: false, type: "string", serde: new PrimitiveSerde("search", "search", "text"), immutable: false },
    "deletedAt": { kind: "primitive", fieldName: "deletedAt", fieldIdName: undefined, derived: false, required: false, protected: false, type: Date, serde: new DateSerde("deletedAt", "deleted_at", "timestamp with time zone"), immutable: false },
    "createdAt": { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: Date, serde: new DateSerde("createdAt", "created_at", "timestamp with time zone"), immutable: false },
    "updatedAt": { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: Date, serde: new DateSerde("updatedAt", "updated_at", "timestamp with time zone"), immutable: false },
    ...
    "author": { kind: "m2o", fieldName: "author", fieldIdName: "authorId", derived: "default", required: true, otherMetadata: () => authorMeta, otherFieldName: "books", serde: new KeySerde("a", "author", "author_id", "int"), immutable: false, default: "config" },
    "reviewer": { kind: "m2o", fieldName: "reviewer", fieldIdName: "reviewerId", derived: "default", required: false, otherMetadata: () => authorMeta, otherFieldName: "reviewerBooks", serde: new KeySerde("a", "reviewer", "reviewer_id", "int"), immutable: false, default: "config" },
...
export const publisherMeta: EntityMetadata<Publisher> = {
  ...
  fields: {
    ...
    "baseSyncDefault": { kind: "primitive", fieldName: "baseSyncDefault", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "string", serde: new PrimitiveSerde("baseSyncDefault", "base_sync_default", "text"), immutable: false, default: "config" },
    "baseAsyncDefault": { kind: "primitive", fieldName: "baseAsyncDefault", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "string", serde: new PrimitiveSerde("baseAsyncDefault", "base_async_default", "text"), immutable: false, default: "config" },
    "createdAt": { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: Date, serde: new DateSerde("createdAt", "created_at", "timestamp with time zone"), immutable: false },
    "updatedAt": { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: Date, serde: new DateSerde("updatedAt", "updated_at", "timestamp with time zone"), immutable: false },
    ...
    "type": { kind: "enum", fieldName: "type", fieldIdName: undefined, required: true, derived: "default", enumDetailType: PublisherTypes, serde: new EnumFieldSerde("type", "type_id", "int", PublisherTypes), immutable: false, default: "config" },
...
export const taskMeta: EntityMetadata<Task> = {
  ...
  fields: {
    ...
    "durationInDays": { kind: "primitive", fieldName: "durationInDays", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "number", serde: new PrimitiveSerde("durationInDays", "duration_in_days", "int"), immutable: false, default: "config" },
    "deletedAt": { kind: "primitive", fieldName: "deletedAt", fieldIdName: undefined, derived: false, required: false, protected: false, type: Date, serde: new DateSerde("deletedAt", "deleted_at", "timestamp with time zone"), immutable: false },
    "syncDefault": { kind: "primitive", fieldName: "syncDefault", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "string", serde: new PrimitiveSerde("syncDefault", "sync_default", "text"), immutable: false, default: "config" },
    "asyncDefault_1": { kind: "primitive", fieldName: "asyncDefault_1", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "string", serde: new PrimitiveSerde("asyncDefault_1", "async_default_1", "text"), immutable: false, default: "config" },
    "asyncDefault_2": { kind: "primitive", fieldName: "asyncDefault_2", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "string", serde: new PrimitiveSerde("asyncDefault_2", "async_default_2", "text"), immutable: false, default: "config" },
...
export const userMeta: EntityMetadata<User> = {
  ...
  fields: {
    ...
    "bio": { kind: "primitive", fieldName: "bio", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "string", serde: new PrimitiveSerde("bio", "bio", "character varying"), immutable: false, default: "schema" },
    "originalEmail": { kind: "primitive", fieldName: "originalEmail", fieldIdName: undefined, derived: "default", required: false, protected: false, type: "string", serde: new PrimitiveSerde("originalEmail", "original_email", "character varying"), immutable: false, default: "config" },
