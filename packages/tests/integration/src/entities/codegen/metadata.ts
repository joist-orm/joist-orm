...
export const publisherMeta: EntityMetadata<Publisher> = {
  ...
  fields: {
    ...
    "namesSnapshot": { kind: "primitive", fieldName: "namesSnapshot", fieldIdName: undefined, derived: "async", required: false, protected: false, type: "string", serde: new PrimitiveSerde("namesSnapshot", "names_snapshot", "text"), immutable: false },
