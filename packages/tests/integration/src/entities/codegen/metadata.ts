...
export const publisherMeta: EntityMetadata<Publisher> = {
  ...
  fields: {
    ...
    "spotlightAuthor": { kind: "m2o", fieldName: "spotlightAuthor", fieldIdName: "spotlightAuthorId", derived: false, required: false, otherMetadata: () => authorMeta, otherFieldName: "spotlightAuthorPublishers", serde: new KeySerde("a", "spotlightAuthor", "spotlight_author_id", "int"), immutable: false },
