...
export const bookReviewMeta: EntityMetadata<BookReview> = {
  ...
  fields: {
    ...
    "bestReviewAuthors": { kind: "m2m", fieldName: "bestReviewAuthors", fieldIdName: "bestReviewAuthorIds", required: false, otherMetadata: () => authorMeta, otherFieldName: "bestReviews", serde: undefined, immutable: false, joinTableName: "authors_to_best_reviews", columnNames: ["book_review_id", "author_id"] },
