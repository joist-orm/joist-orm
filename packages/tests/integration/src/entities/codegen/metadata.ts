...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "amountOfBooks": { kind: "primitive", fieldName: "amountOfBooks", fieldIdName: undefined, derived: "async", required: false, protected: false, type: "number", serde: new PrimitiveSerde("amountOfBooks", "amount_of_books", "int"), immutable: false },
