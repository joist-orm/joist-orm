import { BigIntSerde, configureMetadata, CustomSerdeAdapter, DecimalToNumberSerde, EntityManager as EntityManager1, EnumArrayFieldSerde, EnumFieldSerde, JsonSerde, KeySerde, PolymorphicKeySerde, PrimitiveSerde, SuperstructSerde, ZodSerde } from "joist-orm";
...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "graduated": { kind: "primitive", fieldName: "graduated", fieldIdName: undefined, derived: false, required: false, protected: false, type: Temporal.PlainDate, serde: new PrimitiveSerde("graduated", "graduated", "date"), immutable: false },
    ...
    "deletedAt": { kind: "primitive", fieldName: "deletedAt", fieldIdName: undefined, derived: false, required: false, protected: false, type: Temporal.ZonedDateTime, serde: new PrimitiveSerde("deletedAt", "deleted_at", "timestamp with time zone"), immutable: false },
