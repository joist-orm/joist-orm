...
export const largePublisherMeta: EntityMetadata<LargePublisher> = {
  ...
  fields: {
    ...
    "rating": { kind: "primitive", fieldName: "rating", fieldIdName: undefined, derived: false, required: true, protected: false, type: "number", serde: new PrimitiveSerde("rating", "rating", "int", false, false, { sqlNullable: false, hasDefault: false, isGenerated: false }), immutable: false },
    "spotlightAuthor": { kind: "m2o", fieldName: "spotlightAuthor", fieldIdName: "spotlightAuthorId", derived: false, required: true, otherMetadata: () => authorMeta, otherFieldName: "spotlightAuthorPublishers", serde: new KeySerde("a", "spotlightAuthor", "spotlight_author_id", "int", { sqlNullable: false, hasDefault: false, isGenerated: false }), immutable: false },
...
export const taskOldMeta: EntityMetadata<TaskOld> = {
  ...
  fields: {
    "id": { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new KeySerde("task", "id", "id", "int", { sqlNullable: false, hasDefault: true, isGenerated: false }), immutable: true },
    "specialOldField": { kind: "primitive", fieldName: "specialOldField", fieldIdName: undefined, derived: false, required: true, protected: false, type: "number", serde: new PrimitiveSerde("specialOldField", "special_old_field", "int", false, false, { sqlNullable: false, hasDefault: false, isGenerated: false }), immutable: false },
