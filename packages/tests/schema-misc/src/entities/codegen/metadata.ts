...
export const artistMeta: EntityMetadata<Artist> = {
  ...
  fields: {
    id: {
      ...
      required: true,
      serde: new KeySerde("artist", "id", "id", "uuid"),
      immutable: true,
    },
    firstName: {
      kind: "primitive",
    ...
    createdAt: {
      ...
      protected: false,
      type: Date,
      serde: new DateSerde("createdAt", "createdAt", "timestamp without time zone"),
      immutable: false,
      default: "schema",
    },
    updatedAt: {
      ...
      protected: false,
      type: Date,
      serde: new DateSerde("updatedAt", "updatedAt", "timestamp without time zone"),
      immutable: false,
    },
    paintings: {
      kind: "o2m",
      fieldName: "paintings",
      fieldIdName: "paintingIds",
      required: false,
      otherMetadata: () => paintingMeta,
      otherFieldName: "artist",
      serde: undefined,
      immutable: false,
    },
  },
...
export const databaseOwnerMeta: EntityMetadata<DatabaseOwner> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("do", "id", "id", "int"),
      immutable: true,
    },
    name: {
      kind: "primitive",
...
export const paintingMeta: EntityMetadata<Painting> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("p", "id", "id", "uuid"),
      immutable: true,
    },
    title: {
      kind: "primitive",
    ...
    artist: {
      kind: "m2o",
      fieldName: "artist",
      fieldIdName: "artistId",
      derived: false,
      required: true,
      otherMetadata: () => artistMeta,
      otherFieldName: "paintings",
      serde: new KeySerde("artist", "artist", "artistId", "uuid"),
      immutable: false,
    },
  },
  allFields: {},
