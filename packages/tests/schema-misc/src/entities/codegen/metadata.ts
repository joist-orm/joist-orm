import { configureMetadata, EntityManager as EntityManager1, KeySerde, PlainDateTimeSerde, PrimitiveSerde, ZonedDateTimeSerde } from "joist-orm";
...
export const artistMeta: EntityMetadata<Artist> = {
  ...
  fields: {
    ...
    "createdAt": { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: Temporal.PlainDateTime, serde: new PlainDateTimeSerde("createdAt", "createdAt", "timestamp without time zone"), immutable: false, default: "schema" },
    "updatedAt": { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: Temporal.PlainDateTime, serde: new PlainDateTimeSerde("updatedAt", "updatedAt", "timestamp without time zone"), immutable: false },
