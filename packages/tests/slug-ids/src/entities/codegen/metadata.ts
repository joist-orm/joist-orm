...
export const bookMeta: EntityMetadata<Book> = {
  ...
  tableName: "books",
  fields: {
    "id": { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new KeySerde("book", "id", "id", "bigint"), immutable: true },
...
export const commentMeta: EntityMetadata<Comment> = {
  ...
  tableName: "comments",
  fields: {
    "id": { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new KeySerde("cm", "id", "id", "int"), immutable: true },
