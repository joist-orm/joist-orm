...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    ...
    "childrenBirthdays": { kind: "primitive", fieldName: "childrenBirthdays", fieldIdName: undefined, derived: false, required: true, protected: false, type: Temporal.PlainDate, serde: new PlainDateSerde("childrenBirthdays", "children_birthdays", "date[]", true, false), immutable: false, default: "schema" },
    "maybeBirthdays": { kind: "primitive", fieldName: "maybeBirthdays", fieldIdName: undefined, derived: false, required: false, protected: false, type: Temporal.PlainDate, serde: new PlainDateSerde("maybeBirthdays", "maybe_birthdays", "date[]", true, true), immutable: false, default: "schema" },
    ...
    "timestamps": { kind: "primitive", fieldName: "timestamps", fieldIdName: undefined, derived: false, required: true, protected: false, type: Temporal.PlainDateTime, serde: new PlainDateTimeSerde("timestamps", "timestamps", "timestamp without time zone[]", true, false), immutable: false, default: "schema" },
    "maybeTimestamps": { kind: "primitive", fieldName: "maybeTimestamps", fieldIdName: undefined, derived: false, required: false, protected: false, type: Temporal.PlainDateTime, serde: new PlainDateTimeSerde("maybeTimestamps", "maybe_timestamps", "timestamp without time zone[]", true, true), immutable: false, default: "schema" },
    ...
    "times": { kind: "primitive", fieldName: "times", fieldIdName: undefined, derived: false, required: true, protected: false, type: Temporal.PlainTime, serde: new PlainTimeSerde("times", "times", "time without time zone[]", true, false), immutable: false, default: "schema" },
    "maybeTimes": { kind: "primitive", fieldName: "maybeTimes", fieldIdName: undefined, derived: false, required: false, protected: false, type: Temporal.PlainTime, serde: new PlainTimeSerde("maybeTimes", "maybe_times", "time without time zone[]", true, true), immutable: false, default: "schema" },
...
export const bookMeta: EntityMetadata<Book> = {
  ...
  fields: {
    ...
    "timestampTzs": { kind: "primitive", fieldName: "timestampTzs", fieldIdName: undefined, derived: false, required: true, protected: false, type: Temporal.ZonedDateTime, serde: new ZonedDateTimeSerde("timestampTzs", "timestamp_tzs", "timestamp with time zone[]", true, false), immutable: false, default: "schema" },
    "maybeTimestampTzs": { kind: "primitive", fieldName: "maybeTimestampTzs", fieldIdName: undefined, derived: false, required: false, protected: false, type: Temporal.ZonedDateTime, serde: new ZonedDateTimeSerde("maybeTimestampTzs", "maybe_timestamp_tzs", "timestamp with time zone[]", true, true), immutable: false, default: "schema" },
    "createdAt": { kind: "primitive", fieldName: "createdAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: Temporal.ZonedDateTime, serde: new ZonedDateTimeSerde("createdAt", "created_at", "timestamp with time zone"), immutable: false },
    "updatedAt": { kind: "primitive", fieldName: "updatedAt", fieldIdName: undefined, derived: "orm", required: false, protected: false, type: Temporal.ZonedDateTime, serde: new ZonedDateTimeSerde("updatedAt", "updated_at", "timestamp with time zone"), immutable: false },
    "deletedAt": { kind: "primitive", fieldName: "deletedAt", fieldIdName: undefined, derived: false, required: false, protected: false, type: Temporal.ZonedDateTime, serde: new ZonedDateTimeSerde("deletedAt", "deleted_at", "timestamp with time zone"), immutable: false },
