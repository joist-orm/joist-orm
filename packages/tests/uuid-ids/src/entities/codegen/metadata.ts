...
export const authorMeta: EntityMetadata<Author> = {
  ...
  fields: {
    id: {
      ...
      required: true,
      serde: new KeySerde("a", "id", "id", "uuid"),
      immutable: true,
    },
    firstName: {
      kind: "primitive",
    ...
    createdAt: {
      ...
      protected: false,
      type: Date,
      serde: new DateSerde("createdAt", "created_at", "timestamp with time zone"),
      immutable: false,
    },
    updatedAt: {
      kind: "primitive",
      ...
      protected: false,
      type: Date,
      serde: new DateSerde("updatedAt", "updated_at", "timestamp with time zone"),
      immutable: false,
    },
    books: {
      kind: "o2m",
...
export const bookMeta: EntityMetadata<Book> = {
  ...
  fields: {
    id: {
      ...
      fieldIdName: undefined,
      required: true,
      serde: new KeySerde("b", "id", "id", "uuid"),
      immutable: true,
    },
    title: {
      kind: "primitive",
    ...
    status: {
      ...
      required: true,
      derived: false,
      enumDetailType: BookStatuses,
      serde: new EnumFieldSerde("status", "status_id", "uuid", BookStatuses),
      immutable: false,
    },
    author: {
      kind: "m2o",
      ...
      serde: new KeySerde("a", "author", "author_id", "uuid"),
      immutable: false,
    },
  },
  allFields: {},
