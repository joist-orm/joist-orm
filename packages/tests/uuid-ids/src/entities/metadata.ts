import { BaseEntity, configureMetadata, EntityManager as EntityManager1, EntityMetadata, PrimitiveSerde } from "joist-orm";
...
export const authorMeta: EntityMetadata<Author> = {
  ...
  tableName: "authors",
  fields: {
    id: { kind: "primitive", fieldName: "id", fieldIdName: undefined, derived: false, required: false, protected: false, type: "string", serde: new PrimitiveSerde("id", "id", "uuid") },
