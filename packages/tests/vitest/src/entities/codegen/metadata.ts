...
export const bookMeta: EntityMetadata<Book> = {
  ...
  supportsEmExecute: true,
  fields: {
    "id": { kind: "primaryKey", fieldName: "id", fieldIdName: undefined, required: true, serde: new KeySerde("b", "id", "id", "int", { sqlNullable: false, hasDefault: false, isGenerated: false }), immutable: true },
  ...
  columns: { "id": { "fieldName": "id" }, "title": { "fieldName": "title" }, "deleted_at": { "fieldName": "deletedAt" }, "created_at": { "fieldName": "createdAt" }, "updated_at": { "fieldName": "updatedAt" }, "author_id": { "fieldName": "author" } },
  allFields: {},
  orderBy: undefined,
